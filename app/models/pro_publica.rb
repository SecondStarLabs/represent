class ProPublica
    # credit: https://rubygems.org/gems/ProPublica and https://github.com/omarcodex/propublica-gem
    # captproton amended some of the methods to include an id, which is a BioGuide ID for the members of congress
  require 'net/http'
  require 'json'
